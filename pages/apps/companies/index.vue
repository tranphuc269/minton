                ...
                <div class="card-body">
                    <div class="media">
                        ...
                        <b-dropdown right toggle-class="text-body p-0" variant="black">
                          ...
                          <b-dropdown-item>Sửa</b-dropdown-item>
                            <b-dropdown-item>Xoá</b-dropdown-item>
                        </b-dropdown>
                    </div>
                    <hr v-if="companiesdata.revenue">
                    <div class="text-muted">
                        <div class="row">
                            <div class="col-6">
                                <div>
                                    <p class="text-truncate mb-0">Lượt truy cập</p>
                                    <h5 class="mb-sm-0">{{ companiesdata.revenue }}</h5>
                                </div>
                            </div>
                            <div class="col-6">
                                <div>
                                    <p class="text-truncate mb-0">Dung lượng</p>
                                    <h5 class="mb-sm-0">{{ companiesdata.employees }}</h5>
                                </div>
                            </div>
                        </div>
